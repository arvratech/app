...
#define P_REINITIALIZE_CR		0x83
#define P_RUN_SCRIPT			0x84
#define P_DOWNLOAD_FIRMWARE_CR	0x85
#define P_DOWNLOAD_WALLPAPER_CR	0x86
#define P_DOWNLOAD_KERNEL_CR	0x87
#define P_DOWNLOAD_POLL_CR		0x88
#define P_DOWNLOAD_VIDEO_CR		0x89
