...
// inserted by KDK
typedef struct {
	void		  *addr;		// virtual address in user space
	void		  *vaddr;		// virtual address in kernal space
	unsigned long paddr;		// physical addr4ess in kernal space
	int			  size;
} S_DRVBLT_MEMORY;
...
#define BLT_ALLOC_MEMORY				_IOW(BLT_IOC_MAGIC, 160, S_DRVBLT_MEMORY)	// inserted by KDK
#define BLT_FREE_MEMORY					_IOW(BLT_IOC_MAGIC, 161, S_DRVBLT_MEMORY)	// inserted by KDK
