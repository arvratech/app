...
int SubmitVideoStreamData(VideoDecoder*        pDecoder,
                          ...
                          int                  nStreamBufIndex);
void ResetVideoStreamBuffer(VideoDecoder* pDecoder);		// inserted by KDK
...
// inserted by KDK
VideoPicture *GetOutputBuffer(VideoDecoder *pDecoder, int index);
int  DequeueOutputBuffer(VideoDecoder *pDecoder);
int  EnqueueOutputBuffer(VideoDecoder *pDecoder, int index);
