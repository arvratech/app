#ifndef _AS3911_DEF_H
#define _AS3911_DEF_H


// AS3911 register addresses
...
#define AS3911_REG_IC_IDENTITY					0x3F	// Chip Id: 0 for old silicon, v2 silicon: 0x09


// AS3911 test register addresses

#define AS3911_REG_ANALOG_TEST					0x01	// RW Analog Test and Observation Register        
#define AS3911_REG_TEST_MODE					0x02	// RW Test Mode Definition Register
#define AS3911_REG_PROM_TEST_MODE				0x03	// RW PROM Test Mode DefinitionRegister


// AS3911 register bit definitions
...
#define AS3911_REG_FIFO_RX_STATUS1_mask_fifo_b		(0x7f)
...
#define AS3911_REG_AM_MOD_DEPTH_CONTROL_mod_8percent	(0x0b<<1)
#define AS3911_REG_AM_MOD_DEPTH_CONTROL_mod_10percent	(0x0e<<1)
...
#define AS3911_CMD_CLEAR_RX_GAIN			0x15	// Clear squelch gain reduction and stop any ongoing squelch process
...
// AS3911 FIFO parameters
#define AS3911_FIFO_SIZE			96	// AS3911 FIFO size (bytes)
#define AS3911_FIFO_TRANSMIT_WL0	32	// water level interrupt transmit water level if IO configuration register 1 bit fifo_lt is zero
#define AS3911_FIFO_TRANSMIT_WL1	16	// water level interrupt transmit water level if IO configuration register 1 bit fifo_lt is one
#define AS3911_FIFO_RECEIVE_WL0		64	// water level interrupt receive water level if IO configuration register 1 bit fifo_lr is zero
#define AS3911_FIFO_RECEIVE_WL1		80	// water level interrupt receive water level if IO configuration register 1 bit fifo_lr is one
